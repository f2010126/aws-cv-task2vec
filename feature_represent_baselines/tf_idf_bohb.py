...
if __name__ == "__main__":
    ...
    configspace.add_hyperparameters([lr, feature_size, batch, epochs])
    ...
    smac = SMAC4MF(scenario=scenario, tae_runner=train_random_forest, intensifier_kwargs= {"initial_budget": 1, "max_budget": 25})
